...
const About = () => {
    return (
        <>
            <div id="about" className="section h-full bg-[#0c2543] flex flex-col gap-6 lg:flex-row lg:space-x-14 md:pl-8 md:pr-8 lg:pl-16 pt-12 lg:pr-16 place-items-center pr-4 pl-4">
            <div className="w-full lg:w-1/2 flex items-center pl-0 sm:pl-24 lg:pl-0 order-1 lg:order-0">
