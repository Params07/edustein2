...
const About = () => {
    return (
        <>
            <div id="about" className="h-full bg-[#0c2543] flex flex-col gap-6 lg:flex-row lg:space-x-14 md:pl-8 md:pr-8 lg:pl-16 pt-12 lg:pr-16 place-items-center pr-4 pl-4">
